...
function useVisualElement(Component3, visualState, props, createVisualElement2, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react10.useRef)(Boolean(optimisedAppearId) && !window.MotionHandoffIsComplete && ((_a = window.MotionHasOptimisedAnimation) === null || _a === void 0 ? void 0 : _a.call(window, optimisedAppearId)));
...
// node_modules/framer-motion/dist/es/motion/index.mjs
function createRendererMotionComponent({ preloadedFeatures, createVisualElement: createVisualElement2, useRender, useVisualState: useVisualState2, Component: Component3 }) {
